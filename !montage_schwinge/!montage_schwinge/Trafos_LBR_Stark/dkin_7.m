function [model config] = dkin_7(angles7_6, robot)
%
...
%   model{8} liefert den TCP, model{9} das Koordinatensystem der 7. Achse  
%   Es wird nur die Standardkonfiguration [0 0 0] geliefert.
%
%Parameters:
...
%
%Return values:
%model:    1x9 cell array containing homogenous matices
