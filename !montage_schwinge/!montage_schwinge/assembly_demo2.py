...
def load_robot2(base_pos):
    """
        ...
        Args:
            base_pos: Position der Basis im Raum
    """
    robot2 = RobotModel2.LBR_Model(r'STL')
    # Positionierung des Werkzeugs  welches Koor??
    ZF2 = np.array([
        [0, 1, 0,  0.5],
        [1, 0, 0, 0.5],
        [0, 0, -1, 0.5],
    ...
    robot2.set_tool(ZF2)
    # Positionierung des Roboters
    robot2.set_position(base_pos)
    return robot2
    
    
##  def load_robot_parts2():nicht nötig!!
...
robot2 = load_robot2([-2, 1, 5])  ## andere Position
