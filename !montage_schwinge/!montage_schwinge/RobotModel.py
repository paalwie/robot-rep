...
print('imports done in RobotModel')
...
class LBR_Model(RobotModel):
    ...
    def __init__(self, stl_directory):
        ...
        self.initial_position = (0, 0.64, 0)
        
        RobotModel.__init__(self, stl_directory, self.objects_STL, 
            self.initial_orientations, self.initial_position)
            
        robot_trans.setup_octave()
        self.m_robot = robot_trans.get_robot()
